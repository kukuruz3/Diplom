        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassportHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcedureRooms", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Clients_SecondClientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasSystemAccess = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_AspNetUsers_IdentityUserId1",
                        column: x => x.IdentityUserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Employees_ProcedureRooms_ProcedureRoomId",
                        column: x => x.ProcedureRoomId,
                        principalTable: "ProcedureRooms",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcedureRoomId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcedureAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProcedureAssignments_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProcedureAssignments_Procedures_ProcedureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_SecondClientId",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_ProcedureRoomId",
                table: "Employees",
                column: "ProcedureRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcedureAssignments_ClientId",
                table: "ProcedureAssignments",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcedureAssignments_EmployeeId",
                table: "ProcedureAssignments",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcedureAssignments_ProcedureId",
                table: "ProcedureAssignments",
                column: "ProcedureId");
